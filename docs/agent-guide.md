...
7. **Be aware of system resources.** Local search fires up to 102 browser-based connectors in parallel. LFG auto-scales concurrency based on available RAM, but agents can check resources and override:
