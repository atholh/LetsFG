...
│  ┌──────────────┐  ┌──────────────┐  ┌───────────────────────────┐  │
│  │ Cloud Backend │  │ Fast Connectors│ │  102 Airline Connectors   │  │
...
**This means:** If 10 out of 102 connectors fail (timeouts, bot detection, API errors), you still get results from the other 92. The search never fails completely unless *every* source fails.
...
# INFO: Route filter: LHR->BCN -- skipped 82/102 irrelevant connectors
