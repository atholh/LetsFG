"""
IndiGo direct connector — uses Playwright to scrape flight data.
...
async def _get_browser():
    ...
    async with lock:
        ...
        logger.info("IndiGo: Playwright browser launched (headed Chrome)")
        return _browser


class IndiGoConnectorClient:
    """IndiGo Playwright connector — React SPA form search + API interception."""
