"""
Lion Air Playwright connector -- navigates to lionair.co.id and searches flights.
...
async def _get_browser():
    ...
    async with lock:
        ...
        logger.info("LionAir: Playwright browser launched (headed Chrome)")
        return _browser


class LionAirConnectorClient:
    """LionAir Playwright connector -- homepage form search + API interception."""
