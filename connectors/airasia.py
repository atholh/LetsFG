"""
AirAsia Playwright connector -- navigates to airasia.com and searches flights.
...
async def _get_browser():
    ...
    async with lock:
        ...
        logger.info("AirAsia: Playwright browser launched (headed Chrome)")
        return _browser


class AirAsiaConnectorClient:
    """AirAsia Playwright connector -- homepage form search + API interception."""
