"""
Transavia Playwright connector — navigates to Transavia booking page and searches flights.
...
async def _get_browser():
    ...
    async with lock:
        ...
        logger.info("Transavia: Playwright browser launched (headed Chrome)")
        return _browser


class TransaviaConnectorClient:
    """Transavia Playwright connector — homepage form search + API interception."""
